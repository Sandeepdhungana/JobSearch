...
import {
  ...
  SimilarProfileData,
  SocialShareData
} from "../data/freelancer/FreelancerData";
        ...
        <div className="col-md-8 col-sm-8">
          <div className="container-detail-box">
            <div className="apply-job-header">
              ...
              <a href={FreelancerData[0].profile} className="cl-success">
                <span>
                  <i className="fa fa-building"> </i>
                  {FreelancerData[0].place}
                </span>
              </a>
              <span>
                <i className="fa fa-map-marker"></i>
                {FreelancerData[0].location}
              </span>
            </div>
            ...
            <div className="apply-job-detail">
              {FreelancerData[0].description.map((data) => {
                return (
                  <p key={data.id} p1={data.p1} p2={data.p2} p3={data.p3} />
                );
              })}
            </div>
            ...
            <div className="apply-job-detail">
              ...
              <ul className="language">
                <li>
                  <img className="flag" src="assets/img/gb.svg" alt="" />
                  English
                </li>
                <li>
                  <img className="flag" src="assets/img/gb.svg" alt="" />
        ...
        <div className="col-md-4 col-sm-4">
          ...
          <div class="sidebar-wrapper">
            ...
            <ul class="block-list">
              ...
              <li>
                <i class="fa fa-briefcase cl-success"></i>
                {data.portfolio.portfolio}
              </li>
              <li>
                <i class="fa fa-pencil cl-success"></i>
                {data.portfolio.blog}
              </li>
            </ul>
          </div>
